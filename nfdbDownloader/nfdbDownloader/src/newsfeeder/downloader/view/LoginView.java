...
import newsfeeder.downloader.util.*;
...
public class LoginView extends NewsFeederView
{
	...
	protected void SetupMenuPanel(JPanel menuPanel)
	{
		...
		ImageIcon settingsLabelIcon = new ImageIcon(getClass().getResource("/images/settings.png"));
		JLabel settingsLabel = new JLabel();
		settingsLabel.setIcon(settingsLabelIcon);
		settingsLabel.setText("Settings");
		//settingsLabel.addMouseListener(new SettingsController.SettingsMouseListener());
		
		//floatRight.add(settingsLabel, BorderLayout.EAST);

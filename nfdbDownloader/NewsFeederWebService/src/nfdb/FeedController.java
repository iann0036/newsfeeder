...
public class FeedController {
  ...
  protected FeedController(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  protected static long getCPtr(FeedController obj) {
  ...
  public feedvector GetFeedsByCphId(int cphId) {
    return new feedvector(libnfdbJNI.FeedController_GetFeedsByCphId(swigCPtr, this, cphId), true);
  }

  public feedvector GetFeedsByUsername(String username) {
    return new feedvector(libnfdbJNI.FeedController_GetFeedsByUsername(swigCPtr, this, username), true);
  }

  public feedvector GetAllFeeds() {
    return new feedvector(libnfdbJNI.FeedController_GetAllFeeds(swigCPtr, this), true);
  }
  ...
  public feedvector GetNewFeeds(int id) {
    return new feedvector(libnfdbJNI.FeedController_GetNewFeeds(swigCPtr, this, id), true);
  }

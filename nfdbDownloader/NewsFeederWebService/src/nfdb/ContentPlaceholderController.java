...
public class ContentPlaceholderController {
  ...
  protected ContentPlaceholderController(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  protected static long getCPtr(ContentPlaceholderController obj) {
  ...
  public cphvector GetContentPlaceholdersBySheetId(int sheetId) {
    return new cphvector(libnfdbJNI.ContentPlaceholderController_GetContentPlaceholdersBySheetId(swigCPtr, this, sheetId), true);
  }

  public cphvector GetAllContentPlaceholders() {
    return new cphvector(libnfdbJNI.ContentPlaceholderController_GetAllContentPlaceholders(swigCPtr, this), true);
  }

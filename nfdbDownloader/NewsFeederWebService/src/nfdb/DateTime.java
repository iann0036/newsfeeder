...
public class DateTime {
  ...
  public String ExportToMySQL() {
    return libnfdbJNI.DateTime_ExportToMySQL(swigCPtr, this);
  }

  public void ImportFromMySQL(String source) {
    libnfdbJNI.DateTime_ImportFromMySQL(swigCPtr, this, source);
  }
  ...
  public void ParseFromRFC822(String source) {
    libnfdbJNI.DateTime_ParseFromRFC822(swigCPtr, this, source);
  }

  public void ParseFromRFC3339(String source) {
    libnfdbJNI.DateTime_ParseFromRFC3339(swigCPtr, this, source);
  }
  ...
  public boolean LessThan(DateTime rhs) {
    return libnfdbJNI.DateTime_LessThan(swigCPtr, this, DateTime.getCPtr(rhs), rhs);
  }

  public boolean GreaterThan(DateTime rhs) {
    return libnfdbJNI.DateTime_GreaterThan(swigCPtr, this, DateTime.getCPtr(rhs), rhs);
  }

  public boolean EqualsEquals(DateTime rhs) {
    return libnfdbJNI.DateTime_EqualsEquals(swigCPtr, this, DateTime.getCPtr(rhs), rhs);
  }

  public boolean NotEquals(DateTime rhs) {
    return libnfdbJNI.DateTime_NotEquals(swigCPtr, this, DateTime.getCPtr(rhs), rhs);
  }

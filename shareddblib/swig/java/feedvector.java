...
public class feedvector {
  ...
  public feedvector(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(feedvector obj) {
  ...
  public Feed get(int i) {
    return new Feed(libnfdbJNI.feedvector_get(swigCPtr, this, i), false);
  }

...
public class SheetController {
  ...
  public SheetController(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(SheetController obj) {
  ...
  public SWIGTYPE_p_std__vectorT_nfdb__Sheet_p_t GetSheetsByUsername(String username) {
    return new SWIGTYPE_p_std__vectorT_nfdb__Sheet_p_t(libnfdbJNI.SheetController_GetSheetsByUsername(swigCPtr, this, username), true);
  }

  public SWIGTYPE_p_std__vectorT_nfdb__Sheet_p_t GetAllSheets() {
    return new SWIGTYPE_p_std__vectorT_nfdb__Sheet_p_t(libnfdbJNI.SheetController_GetAllSheets(swigCPtr, this), true);
  }

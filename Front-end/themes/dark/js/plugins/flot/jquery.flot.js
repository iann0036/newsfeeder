        ...
        var series = [],
            options = {
                ...
                grid: {
                    show: true,
                    aboveData: false,
                    color: "#d5d5d5", // primary color used for outline and labels
                    backgroundColor: null, // null for transparent, else color
                    borderColor: "#3B4144", // set if different from the grid color
                    tickColor: "#3B4144", // color for the ticks, e.g. "rgba(0,0,0,0.15)"
                    labelMargin: 5, // in pixels
                    axisMargin: 8, // in pixels
                    borderWidth: 0, // in pixels
                    minBorderMargin: 10, // in pixels, null means taken from points radius
                    markings: null, // array of ranges or fn: axes -> array of ranges
                    markingsColor: "#d5d5d5",
                    markingsLineWidth: 2,
                    // interactive stuff
                    clickable: false,
                    hoverable: false,
